        ...
        <ul class="list-group list-group-flush ">
          <li class="list-group-item dash">
            ...
            <p>
              ...
              extensive collection of resources for fighting COVID in Hyderabad.
              Powered by Soapbox by Medha Kadri. If you have resources you want
              us to add, fill this form: https://t.co/rtOG0Dsm16”
            </p>
          </li>
          ...
          <li class="list-group-item dash">
            ...
            <p>
              ...
              requirements and donation, oxygen cylinders, doctor consultation,
              meal services, and vaccinations.
            </p>
          </li>
        </ul>
      </div>
