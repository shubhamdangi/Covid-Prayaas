        ...
        <div className="contents">
          <ul class="list-group list-group-flush">
            <li class="list-group-item">
              <Link
                to={{ pathname: "https://bhopalcovidbeds.in/" }}
                target="blank"
              >
                <h3>▷Bed Availability Dashboard</h3>
              </Link>
              <p>
                Bed Availability in COVID Hospital. Contains information of
                number and details of Isolation Ward beds, Oxygen beds and
                ICU/HDU beds.
              </p>
            </li>
            <li class="list-group-item">
              <Link
                to={{ pathname: "https://bhopal.nic.in/en/" }}
                target="blank"
              >
