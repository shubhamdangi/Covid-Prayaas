  ...
  return (
    <>
      <div className="pagedata">
        <div className="dash">
          <div className="Head">
            <img src={ranchiImage} alt="ranchi-image" className="ranchiImage" />
          ...
          <div className="contents">
            <ul class="list-group list-group-flush ">
              <li class="list-group-item dash">
                ...
                <p>
                  COVID Dashboard on the official website of the state
                  containing COVID Helpline and other useful information.
                </p>
              </li>
              ...
              <li class="list-group-item dash">
                ...
                <p>
                  Contains Helpline numbers in the district and other useful
                  info.
                </p>
              </li>
              <li class="list-group-item dash">
                ...
                <p>
                  कोरोना वायरस सूचना - Contains Helpline numbers in the district
