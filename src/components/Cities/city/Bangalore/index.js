            ...
            <ul class="list-group list-group-flush ">
              <li class="list-group-item dash">
                ...
                <p>
                  ...
                  COVID-19 beds available in various government hospitals &
                  medical colleges, Private hospitals & medical colleges, and
              ...
              <li class="list-group-item  dash">
                ...
                <p>
                  Live information on beds and plasma availability, updated
                  every 15 minutes. <br />
              ...
              <li class="list-group-item  dash">
                ...
                <p>
                  ...
                  Twitter’s live feed for current information on resources.
                  <br />
              ...
              <li class="list-group-item dash">
                ...
                <p>
                  ...
                  volunteers called #NammaTeam assists you in getting help from
                  the govt and also provides direct help wherever possible. It's
                  FREE and 24x7. Text on Telegram Messenger to reach them.
                </p>
              </li>
              ...
              <li class="list-group-item dash">
                ...
                <p>
                  Mercy Mission is a group of 20+ NGO's working in different
                  parts of Bangalore.{" "}
                  <a href="https://twitter.com/mercymission1">(Twitter link)</a>{" "}
                  <br /> ⦾ <b>Mercy Ambulance :</b> 7676881882 (ambulances
                  services to and from hospitals) <br />⦾ <b>Mercy Oxygen :</b>{" "}
                  08047191133 (medical oxygen for emergency and COVID19 post
                  hospitalization therapy) <br />⦾ <b>Mercy Booth :</b>{" "}
                  8660856709 for testing, hospitalization support for needy)
                  <br /> ⦾ <b>Mercy Plasma :</b> 08047191133, Press 2 (plasma
                  support for COVID-19 patients)
                  <br /> ⦾ <b>Mercy Angels :</b> 08047191134 (dignified last
                  journey to burial/cremation Grounds)
                </p>
              </li>
              <li class="list-group-item dash">
                <h3>▷Useful Twitter Accounts</h3>
                <p>
                  <a href="https://twitter.com/WeAreBangalore">
                    {" "}
                    WeAreBangalore:{" "}
                  </a>{" "}
                  WeAreBangalore: Seek and provide COVID-related assistance for
                  the Bengaluru community
                  <br />
                  <a href="https://twitter.com/peakbengaluru">
                    Peakbangalore:{" "}
                  </a>
              ...
              <li class="list-group-item dash">
                ...
                <p>
                  ...
                  Here's a comprehensive guide containing a list of resources
                  for all requirements that one might have while testing
                  positive for COVID 19. For more information or queries, please
