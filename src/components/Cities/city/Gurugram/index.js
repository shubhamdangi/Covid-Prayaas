            ...
            <ul class="list-group list-group-flush ">
              <li class="list-group-item dash">
                ...
                <p>
                  ...
                  <br />
                  ⦾ Register for a hospital bed (for Gurugram residents only){" "}
                  <br />
                  ⦾ COVID-19 hospitals: Address, contact number and availability
                  of oxygen beds, ICU beds and ventilator beds. <br />
              ...
              <li class="list-group-item dash">
                ...
                <p>
                  District Gurugram’s help desk for COVID19. Contains
                  information such as helpline numbers, paid quarantine
                  facilities and more.
                </p>
              </li>
              ...
              <li class="list-group-item dash">
                ...
                <p>
                  “District Administration Gurugram is inviting you to a
                  scheduled Zoom meeting to interact with the Medical team.
