...
import rol from "../Navbar/roli7.gif";
        ...
        <div className="Head">
          ...
          <h3 style={{ margin: "0 6px 0 5px" }}>
            ...
            <span style={{ color: "#222831" }}>
              &nbsp;Select the <span style={{ fontWeight: "550" }}>Cities</span>{" "}
              and <span style={{ fontWeight: "550" }}>States</span> from the
        ...
        <div className="contents">
          <ul class="list-group list-group-flush ">
            <li class="list-group-item dash">
              ...
              <p>
                Crowdsourced COVID-19 resources including Oxygen, Hospital Beds,
                Remdesivir, Plasma/Blood, Food, Ambulance, Testing and Emergency
                services. <br /> Can be searched by state and city.
              </p>
            </li>
            <li class="list-group-item dash">
              ...
              <p>
                Crowdsourced contact numbers for resources such as beds, oxygen,
                plasma and more across India and different cities.
              </p>
            </li>
            <li class="list-group-item dash">
              ...
              <p>
                ...
                <br /> Twitter: <a href="https://twitter.com/CovRelief">Link</a>
            ...
            <li class="list-group-item dash">
              ...
              <p>
                ...
                Beds, Oxygen Cylinders and Plasma. Can be categorized by “India”
                or specific states.
              </p>
            </li>
            <li class="list-group-item dash">
              ...
              <p>
                ...
                live feed for current information on resources such as beds,
                oxygen, etc in various cities of India.
              </p>
            </li>
            <li class="list-group-item dash">
            ...
            <li class="list-group-item dash">
              ...
              <p>
                Crowdsourced resources to fight COVID across India. Find oxygen,
                plasma, medicines, hospital beds and more.
              </p>
            </li>
            <li class="list-group-item dash">
            ...
            <li class="list-group-item dash">
              ...
              <p>
                ...
                plasma resources for Pan India and State, and COVID19 medicines.{" "}
              </p>
            </li>
            <li class="list-group-item dash">
              ...
              <p>
                Website with details of meal providers across India, categorized
                by state and city.{" "}
              </p>
            </li>
            <li class="list-group-item dash">
            ...
            <li class="list-group-item dash">
              ...
              <p>
                ...
                not-for-profit initiative that connects COVID patients to plasma
                donors across India),{" "}
