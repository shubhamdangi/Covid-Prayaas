        ...
        <ul class="list-group list-group-flush ">
          <li class="list-group-item dash">
            ...
            <p>
              ...
              centers, oxygen suppliers, covid test centers, pharmacies, plasma
              help, vaccination centers, cooked food, pet sitters, emergency
              requirement, quarantine centers, ambulances and tele-consultation.
            </p>
          </li>
        </ul>
      </div>
