          ...
          <div className="contents">
            <ul class="list-group list-group-flush ">
              <li class="list-group-item dash">
                ...
                <p>
                  Centralized COVID19 information for Haryana. Contains
                  information about hospitals, care centers, testing labs and
                  collection centers. <br /> <br /> Provides bed availability
                  details across Haryana and Gurugram.
                </p>
              </li>
            </ul>
          </div>
