          ...
          <div className="contents">
            <ul class="list-group list-group-flush ">
              <li class="list-group-item dash">
                ...
                <p>
                  Live dashboard of regular beds, oxygen beds and ICU beds
                  across government hospitals and private hospitals. Clicking on
                  “Government Hospitals” or “Private Hospitals” expands the
                  dashboard to hospital details such as district, name and phone
                  number.
                  <br /> <br /> Created by Department of Health, Medical &
