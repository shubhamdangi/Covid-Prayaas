      ...
      <div className="dash">
        ...
        <ul class="list-group list-group-flush ">
          <li class="list-group-item dash">
            ...
            <p>
              Live dashboard of Occupied and Vacant COVID19 Beds and ICU Beds
              available. Data reported by Nodal Officers of each Dedicated
              COVID-19 Hospital.
            </p>
          </li>
          ...
          <li class="list-group-item dash">
            ...
            <p>
              This tool enables you to view availability of beds, ventilators
              and other critical Covid infrastructure on a map so you can find
              one close to you. <br /> <br /> Twitter:{" "}
              <a href="https://twitter.com/covid_map_india">@covid_map_india</a>
            </p>
          </li>
          ...
          <li class="list-group-item dash">
            <a href="https://hemkuntfoundation.com/oxygen-cylinder/">
              <h3>
                ▷Free Oxygen Cylinders for COVID patients (Hemkunt Foundation)
              </h3>
            </a>
          ...
          <li class="list-group-item dash">
            ...
            <p>
              Contains helplines for COVID19 assistance, ambulances, blood banks
              and more.
            </p>
          </li>
        </ul>
