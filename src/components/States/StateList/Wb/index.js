        ...
        <ul class="list-group list-group-flush ">
          <li class="list-group-item dash">
            ...
            <p>
              ...
              Oxygen on Rent, Medicine, Plasma/Blood Donation, Ambulance, COVID
              Testing, Home Care Facilities, Private Hospitals, Mental Health
              Resources, Tele-medicine Services, Meals/Medicine Delivery for
              Patients, Helplines and other resources.
            </p>
          </li>
