            ...
            <ul class="list-group list-group-flush ">
              <li class="list-group-item dash">
                ...
                <p>
                  ...
                  numbers.
                  <br /> <br /> Created by Health &Welfare Department,
              ...
              <li class="list-group-item dash">
                ...
                <p>
                  A dashboard of bed availability in government and private
                  COVID hospitals, health centers and care centers.
              ...
              <li class="list-group-item dash">
                ...
                <p>
                  PDF file containing a list of testing labs across Tamil Nadu.
                </p>
              </li>
              ...
              <li class="list-group-item dash">
                ...
                <p>
                  Official twitter handle of National Health Mission, Tamil
                  Nadu. Stay Connected for news & information on COVID-19 & Govt
                  health initiatives in Tamil Nadu.{" "}
                </p>
              </li>
            </ul>
          </div>
